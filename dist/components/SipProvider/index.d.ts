...
export default class SipProvider extends React.Component<JsSipConfig, JsSipState> {
    static childContextTypes: {
        ...
        changeVideoResolution: PropTypes.Requireable<(...args: any[]) => any>;
        getVideoResolution: PropTypes.Requireable<(...args: any[]) => any>;
    ...
    getChildContext(): {
        ...
        changeVideoResolution: any;
        getVideoResolution: any;
        mediaDevices: MediaDevice[];
