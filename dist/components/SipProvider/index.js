...
var Constants_1 = require("react-native-jssip/lib/Constants");
var SipProvider = (function (_super) {
    ...
    function SipProvider(props) {
        ...
        _this._initProperties = function () {
            ...
            _this._mediaEngine = new mediaengine_1.MediaEngine(_this.eventBus);
        };
        ...
        _this.changeVideoResolution = function (res) {
            _this._mediaEngine.setVideoRes(res);
        };
        _this.getVideoResolution = function () {
            return _this._mediaEngine.getVideoRes();
        };
        ...
        _this.ua = null;
        _this.eventBus = new events_1.EventEmitter();
        return _this;
    }
